...
export class ApplyNowComponent implements OnInit {
  ...
  expectList = [
    {id: "1", listItem: "Prior experience with harvesting, farming, and trucking as well as mechanical and welding skills are important for being able to effectively contribute to DHT services."},
    {id: "2", listItem: "Extensive travel with mobile housing accommodations potentially covering many Southern and Midwest states."},
    {id: "3", listItem: "The recruiting process will include up to three online interviews and a reference check. Upon approval numerous documents will need to be signed and submitted online."},
    {id: "4", listItem: "Candidates are expected to prepare, study, and complete online CDL and safety training materials prior to arrival. This may also include attending online team meetings."},
    {id: "5", listItem: "Transportation to and from the airport will be provided for both arrival and departure."},
  ]
  requirementsList = [
