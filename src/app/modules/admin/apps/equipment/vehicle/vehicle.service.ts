...
export class VehicleService
{
    ...
    {
        return this._httpClient.get<{ pagination: InventoryPagination; products: InventoryProduct[] }>('api/apps/equipment/vehicle/products', {
            params: {
                page: '' + page,
                size: '' + size,
                sort,
     ...
     * Get product by id
     */
    getVehicleById(id: string): Observable<InventoryProduct>
    {
