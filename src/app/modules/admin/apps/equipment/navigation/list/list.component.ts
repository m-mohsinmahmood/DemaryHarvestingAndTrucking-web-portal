...
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryTag, InventoryVendor } from '../../machinery/machinery.types';
...
export class ListComponent implements OnInit {
  ...
  toggleDetails(machineId: string): void {
      ...
      this._router.navigateByUrl(`/apps/equipment/machinery/details/${machineId}`, { state: { title: 'Profile' } });
