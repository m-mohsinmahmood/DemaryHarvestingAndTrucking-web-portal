...
export class ImportDestinationsComponent implements OnInit {
  ...
  constructor(
    ...
    public matDialogRef: MatDialogRef<ImportDestinationsComponent>,
  ...
  upload() {
    ...
    fileReader.onload = async (e) => {
      ...
      if (this.isFileError) {
        ...
        utils.sheet_add_json(ws, this.importCustomerDestinationList, {
          origin: 'A2',
          skipHeader: true,
        });
        ...
        this._customersService.customerImport(this.importCustomerDestinationList, this.data?.limit, this.data?.sort, this.data?.order, this.data?.search, this.data?.filters);
      }
      this.saveAndClose();
    };
