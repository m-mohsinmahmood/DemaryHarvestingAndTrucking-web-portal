...
export class ListFarmComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.search = this.searchform.valueChanges
      ...
      .subscribe((data) => {
        ...
        this.page = 1;
        this._customerService.getCustomerFarm(this.routeID, this.page, 10, '', '', this.searchResult)
      });
  ...
  deleteCustomerFarm(id: string){
    this._customerService.deleteCustomerFarm(id, this.routeID)
  }
  //#endregion
  ...
  sortData(sort: any) {
    ...
    this._customerService.getCustomerFarm(this.routeID, this.page, this.limit, this.farmSort[0], this.farmSort[1], this.searchResult);
  }
  //#endregion
