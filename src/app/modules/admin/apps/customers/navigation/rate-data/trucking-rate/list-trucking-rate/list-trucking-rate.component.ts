...
export class ListTruckingRateComponent implements OnInit {
    ...
    //#region Sorting
    sortData(sort: any) {
        this.truckingRateSort[0] = sort.active;
        this.truckingRateSort[1] = sort.direction;
        this._customerService.getTruckingRate(
            this.routeID,
            this.truckingRateSort[0],
            this.truckingRateSort[1],
            this.searchResult
        );
    }
    //#endregion

    //#region Confirmation Customer Trucking Rate Dialog
    confirmDeleteDialog(id: string): void {
        const dialogRef = this._matDialog.open(ConfirmationDialogComponent, {
            data: {
                message: 'Are you sure you want to delete this Trucking Rate?',
                title: 'Trucking Rate',
            },
        });
