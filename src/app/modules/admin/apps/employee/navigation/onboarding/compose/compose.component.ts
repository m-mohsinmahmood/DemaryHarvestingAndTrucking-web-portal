...
export class MailboxComposeComponent implements OnInit {
    ...
    initEmails() {
        this.emails = [
            ...
            },
            {
                ...
                email: 'Dear ' + this.data.employee.first_name + ', </br></br>Thanks for setting up your online bank account.  You are almost finished with the pre-employment (onboarding) process.</br></br>Next, we will need you to carefully review, read, and electronically sign and date the two required DHT compliance documents below.  Thanks again for your help in completing this step.</br></br>Drug Policy (Company Documents Folder) </br>Reprimand Policy (Company Documents Folder)</br></br>Kind regards,'
            },
            {
                id: '6', subject: 'DHT “Onboarding Process” (Step 6 of 7)',
                email: 'Dear ' + this.data.employee.first_name + ', </br></br>Thanks for completing the recent compliance documents.</br></br>In advance of your scheduled start date, we ask all employees who do not currently have their CDL license to review the attached CDL training instructions and website to help study and prepare for their CDL test upon arrival.</br></br>CDL Training Instructions</br>CDL Training Videos Website </br></br>Kind regards,'
            },
            {
    ...
    initH2aEmails() {
        this.h2a_emails = [
            ...
            {
                id: '3', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
            ...
            {
                id: '4', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
            ...
            {
                id: '5', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
            ...
            {
                id: '6', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
            ...
            {
                id: '7', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
                email: 'Dear ' + this.data.employee.first_name + ',</br>Thanks for downloading the DHT Approval Letter.  You are almost finished with the pre-employment (onboarding) process.</br></br>Next, we will need you to carefully review, read, and electronically sign and date the two required DHT compliance documents below.  Thanks again for your help in completing this step.</br></br> Drug Policy (Company Documents Folder) </br></br> Reprimand Policy(Company Documents Folder) </br></br> Departure Policy (Company Documents Folder) </br></br> Equipment Policy (Company Documents Folder) </br></br>Kind regards, '
            },
            {
                id: '8', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
            ...
            {
                id: '9', subject: 'DHT “Onboarding Process” (Step 1 of 9)',
    ...
    send(): void {
        ...
        this._employeeService.patchEmployee(
            Object.assign(this.data.form.value, { to: this.data.employee.email }), 'false'
        );
        this.matDialogRef.close();
