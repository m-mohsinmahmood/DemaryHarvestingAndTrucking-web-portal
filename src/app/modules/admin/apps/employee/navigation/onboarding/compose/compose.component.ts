    ...
    initEmails() {
        this.emails = [
            ...
            },
            {
                ...
                email: 'Dear ' + this.data.employee.first_name + ',<br><br>Thanks for successfully uploading your Social Security Card  and Drivers license.  Next, we will need you to carefully review, read, and electronically sign the four compliance related documents below.  Your electronic signature will be used as verification that you’ve read and understood the contents of these documents. Thanks for your help in gathering this documentation.<br><br>Ag Work Agreement (DOL Folder) <br>Work itinerary (DOL Folder) <br>DHT work rules (DHT Onboarding Documents Folder) <br>Handbook (DHT Onboarding Documents Folder)<br><br>Note, the DHT administrator will send you another email once these four documents have been successfully reviewed/signed.  We appreciate your patience with this process.<br><br> Kind regards,'
            },
            {
                id: '3', subject: 'DHT “Onboarding Process” (Step 3 of 7)',
                email: 'Dear ' + this.data.employee.first_name + ', <br><br>Thanks for successfully signing the required DHT and US Government compliance documentation. Next, we will we need you to review, complete, and electronically sign the attached DHT Contract Letter (DHT Onboarding Documents Folder) and W4 tax (Payroll Document Folder) form.  PLEASE NOTE THAT THE BLANK W4 TAX FORM IS LOCATED IN THE ‘COMPANY DOCUMENTS’ FOLDER IN THE MAIN NAVIGATION WINDOW UNDER THE ‘WORK’ TAB.  PLEASE DOWNLOAD, PRINT, AND COMPLETE THE BLANK W4 AND THEN UPLOAD THE COMPLETED FORM IN THE ONBOADING SECTION (LOOK FOR ROCKETSHIP ICON) IN THE PAYROLL FOLDER. The DHT administrator will send you another email once these two documents have been successfully reviewed/signed.  We appreciate your patience with this process.<br><br>Kind regards,'
            },
            {
            ...
            },
            {
                ...
                email: 'Dear ' + this.data.employee.first_name + ', <br><br>Thanks for setting up your online bank account.  You are almost finished with the pre-employment (onboarding) process.<br><br>Next, we will need you to carefully review and electronically sign the four required DHT Company documents including 1) Drug Policy, 2) Reprimand Policy, 3) Equipment Policy, and 4) Departure Policy (all 4 documents located in the DHT Onboarding Documents Folder).<br><br><br><br>Kind regards,'
            },
            {
                id: '6', subject: 'DHT “Onboarding Process” (Step 6 of 7)',
                email: 'Dear ' + this.data.employee.first_name + ', <br><br>Thanks for completing the recent DHT Company documents.<br><br>In advance of your scheduled start date, we ask all employees who do not currently have their CDL license to review the CDL training instructions and video links.  Please go to the DHT Onboarding Documents folder to verify receipt of CDL training instructions and begin your studying and preparations for your CDL test upon arrival.<br><br>Kind regards,'
            },
            {
    ...
    initH2aEmails() {
        this.h2a_emails = [
            ...
            },
            {
                ...
                email: 'Dear ' + this.data.employee.first_name + 
                ',<br><br>Thanks for successfully uploading your Passport and Driver’s License. In advance of your scheduled start date, we ask all employees who do not currently have their CDL license to review and verify the CDL training instructions document located in the DHT Onboarding Documents folder in the web portal (look for Rocketship icon) to help study and prepare for their CDL test upon arrival.<br><br>Kind regards,'
            },
            {
            ...
            },
            {
                ...
                email: 'Dear ' + this.data.employee.first_name + 
                ',<br><br>Thanks for successfully signing the DHT Contract Letter. Next, to ensure that there are no delays in getting paid, we require all employees set-up an online bank account before they arrive in the United States. In prior years, most of our employees have used a banking organization called Transferwise. We have provided instructions in the Company Documents Dashboard (on the main navigation bar) to set-up a Transferwise account for your convenience, if interested.If you already have a US bank account, please enter this information in the bank account form in the Payroll folder.<br><br>Once you’ve successfully created an online bank account, you will need to visit your DHT web portal to enter the appropriate bank account information in the Payroll folder. Once complete, the DHT administrator will send you another email with more information regarding the next onboarding step.<br><br>Kind regards,</br<br>  '
            },
            {
                id: '6', subject: 'DHT “Onboarding Process” (Step 6 of 12)',
                email: 'Dear ' + this.data.employee.first_name + 
                ',<br><br>Thanks for successfully setting up your online bank account. Next, we will need you to apply for your VISA application. Please note that we have uploaded some “VISA instructions” to your “Company Document” Dashboard (located on the main navigation bar) in the DHT web portal that provides you with more detailed information on how to complete your VISA application.  Importantly, you will need the IOE number from I-797B form (located in the DOI folder) in order to complete your VISA application.  As a reminder, the I-797B form will also need to be reviewed and verified in order to move to the next onboarding step.<br><br>As part of the VISA application process, you will need to request a VISA interview date.  NOTE:  PLEASE DO NOT SCHEDULE AN INTERVIEW DATE LESS THAN THREE WEEKS PRIOR TO YOUR ARRIVAL DATE.  IF YOU ARE NOT ABLE TO DO THIS, PLEASE REVIEW THE VISA INSTRUCTIONS IN THE COMPANY DOCUMENTS DASHBOARD (ON MAIN NAVIGATION BAR) FOR NEXT STEPS.<br><br>After you’ve received an acceptable VISA interview date (e.g., an interview date that takes place at least 3 weeks prior to your start date), you will then need to enter the interview date and consulate details into your online DHT account located within the DOI folder.<br><br>Kind regards,<br><br>'
            },
            {
