...
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, vendors as vendorsData } from 'app/mock-api/apps/equipment/parts-tools/data';

@Injectable({
    providedIn: 'root'
})
export class PartsMockApi
{
