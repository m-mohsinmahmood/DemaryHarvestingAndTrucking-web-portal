...
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, vendors as vendorsData } from 'app/mock-api/apps/equipment/machinery/data';

@Injectable({
    providedIn: 'root'
})
export class MachineryMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/equipment/machinery/products', 300)
            .reply(({request}) => {
